...
import { 
  Search, ListFilter, Download, RefreshCw, Calendar, ChevronDown, BarChart2, Filter, Settings2, FileText, Check, ChevronLeft, ChevronRight, Bookmark, Printer, Activity, Timer, AlertCircle, Clock, User
} from "lucide-react";
         ...
         <div className="w-full max-w-none flex flex-col gap-6">
            ...
            <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm flex flex-col gap-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    {/* Chính sách SLA */}
                    <div className="flex flex-col gap-1.5 relative" ref={policyRef}>
                        ...
                        >
                            <div className="flex items-center gap-2 overflow-hidden w-full pr-4">
                               ...
                               <span className="text-sm font-medium text-gray-700 truncate select-none">
                                  {isAllPoliciesSelected ? "Tất cả chính sách" : `Đã chọn ${selectedPolicies.length} chính sách`}
                               </span>
                            </div>
                    ...
                    {/* Tư vấn viên */}
                    <div className="flex flex-col gap-1.5 relative" ref={agentRef}>

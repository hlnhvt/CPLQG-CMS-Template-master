    ...
    <div className="absolute inset-0 flex flex-col bg-[#f8fafc] overflow-hidden">
      ...
      <header className="h-[72px] border-b border-gray-200 flex items-center justify-between px-6 shrink-0 bg-white shadow-sm z-20">
        <div className="flex items-center gap-4">
          <Link href="/content/content_topic" className="w-10 h-10 rounded-full hover:bg-gray-100 flex items-center justify-center text-gray-400 transition-colors">
            <ArrowLeft size={20} />
          </Link>
          ...
          <div>
            ...
            <h1 className="text-xl font-bold text-[#14233b] text-nowrap leading-tight flex items-center gap-2">
               Đang Chỉnh Sửa Bản Ghi: <span className="text-[#5340FF]">#{id}</span>
            </h1>
          </div>
        </div>
          ...
          {isMenuOpen && (
            <div className="absolute top-12 right-0 w-64 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden flex flex-col mt-1 py-1">
              ...
              >
                 ...
                 <span className="font-medium">Huỷ toàn bộ thay đổi</span>
              </button>
            </div>
          )}
        </div>
         ...
         <div className="w-full max-w-[800px] flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                    ...
                    <input type="text" defaultValue="TDCS" placeholder="VD: TDCS" className="w-full h-11 border border-gray-200 rounded-xl px-4 bg-white outline-none focus:border-[#5340FF] focus:ring-1 focus:ring-[#5340FF] transition-all shadow-sm" />
                </div>
                <div className="flex flex-col gap-2">
                    <label className="text-sm font-bold text-gray-700 flex gap-1 items-center">
                        Tên chủ đề <span className="text-[#5340FF]">*</span>
                    </label>
                    <input type="text" defaultValue="Dự án Tiêu điểm Chính sách" placeholder="Nhập tên chủ đề..." className="w-full h-11 border border-gray-200 rounded-xl px-4 bg-white outline-none focus:border-[#5340FF] focus:ring-1 focus:ring-[#5340FF] transition-all shadow-sm" />
                </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                <div className="relative flex items-center w-full h-11 border border-gray-200 rounded-xl bg-gray-50 overflow-hidden focus-within:bg-white focus-within:border-[#5340FF] focus-within:ring-1 focus-within:ring-[#5340FF] transition-all shadow-sm">
                    ...
                    <input type="text" readOnly defaultValue="du-an-tieu-diem-chinh-sach" placeholder="Tự động sinh từ tên..." className="flex-1 h-full pr-4 outline-none bg-transparent text-sm text-gray-500 font-medium" />
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="relative flex items-center w-full h-11 border border-gray-200 rounded-xl bg-white overflow-hidden focus-within:border-[#5340FF] focus-within:ring-1 focus-within:ring-[#5340FF] transition-all shadow-sm">
                        ...
                        <input type="text" defaultValue="48" placeholder="Chọn sitemap..." className="flex-1 h-full pr-10 outline-none bg-transparent text-sm" />
            ...
            <div className="flex flex-col gap-2">
                ...
                <textarea rows={5} defaultValue="Dự án nghiên cứu và phổ biến các tiêu điểm chính sách quan trọng của nhà nước trong năm 2026." className="w-full border border-gray-200 rounded-xl p-4 bg-white outline-none focus:border-[#5340FF] focus:ring-1 focus:ring-[#5340FF] transition-all resize-y text-sm shadow-sm" placeholder="Nhập mô tả chi tiết cho chủ đề này..."></textarea>
            </div>
